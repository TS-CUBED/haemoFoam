# haemoFoam
Haemodynamics simulation framework based on foam-extend. Includes particle migration model and advanced haemorheology models.
...
The current development is on foam-extend-4.0, but the code will work on foam-extend-4.1. If you need it on OpenFoam v1912, I can port it again, but will need a few days to do that.  
