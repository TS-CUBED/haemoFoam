...
The current development is on OpenFOAM v1912/v2006, but the haemodynamics/haemorheology model will work on foam-extend, the Windkessel model is only implemented in OF v1912/v2006.
